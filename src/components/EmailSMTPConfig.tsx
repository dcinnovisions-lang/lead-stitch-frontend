          ...
          <div className="space-y-6">
            ...
            {!showForm ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-bold text-gray-900">Outlook / Hotmail</h3>
                  ...
                  <div className="space-y-2 text-sm text-gray-700">
                    <p className="font-semibold text-red-600">Requirements:</p>
                    <ul className="list-disc list-inside space-y-1 ml-2">
                      <li>App Password REQUIRED (2FA must be enabled first)</li>
                      <li>Microsoft disabled basic authentication</li>
                      <li>App Passwords may not be available for all accounts</li>
                      <li>Works with @outlook.com, @hotmail.com</li>
                    </ul>
                  </div>
                </button>
              ...
              <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            maxLength={16}
                            className={`w-full px-4 py-3 border-2 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 pr-10 font-mono ${
                ...
                {/* Outlook/Hotmail Configuration Form */}
                {selectedProviderType === 'outlook' && (
                  <div className="bg-gradient-to-br from-purple-50 via-white to-purple-50/30 border border-purple-200 rounded-xl p-6">
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <div>
                        <h3 className="text-xl font-bold text-gray-900">Outlook / Hotmail Configuration</h3>
                    ...
                    {/* Step 1: Enable 2FA First */}
                    <div className="bg-yellow-50 border-2 border-yellow-300 rounded-lg p-4 mb-4">
                      <p className="font-semibold text-yellow-900 mb-2">Step 1: Enable 2FA (Required for App Passwords):</p>
                      <ol className="list-decimal list-inside space-y-1 text-sm text-yellow-800">
                        <li>Go to: <a href="https://account.microsoft.com/security" target="_blank" rel="noopener noreferrer" className="underline font-semibold">account.microsoft.com/security</a></li>
                        <li>Click <strong>"Advanced security options"</strong></li>
                        <li>Under <strong>"Two-step verification"</strong>, click <strong>"Turn on"</strong> or <strong>"Set up"</strong></li>
                        <li>Follow the prompts to enable 2FA (you can use Microsoft Authenticator app or SMS)</li>
                        <li><strong>Important:</strong> App Passwords will only appear AFTER 2FA is enabled</li>
                      </ol>
                    </div>

                    {/* Step 2: Get App Password */}
                    <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 mb-4">
                      <p className="font-semibold text-purple-900 mb-2">Step 2: Create App Password (After 2FA is enabled):</p>
                      <ol className="list-decimal list-inside space-y-1 text-sm text-purple-800">
                        <li>Still on <strong>"Advanced security options"</strong> page</li>
                        <li>Scroll down to <strong>"App passwords"</strong> section</li>
                        <li>Click <strong>"Create a new app password"</strong></li>
                        <li>Enter a name like "Lead Stitch" and click <strong>"Next"</strong></li>
                        <li>Copy the generated 16-character password and use it below</li>
                      </ol>
                    </div>

                    {/* Alternative Solutions */}
                    <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 mb-6">
                      <p className="font-semibold text-purple-900 mb-2">Recommended Solutions:</p>
                      <ul className="list-disc list-inside space-y-1 text-sm text-purple-800">
                        <li><strong>Use Gmail instead:</strong> Gmail App Passwords work reliably and are easier to set up. This is the recommended option.</li>
                        <li><strong>Use a business email:</strong> Custom SMTP servers (like Office 365 Business, Zoho, SendGrid, etc.) often have better SMTP support</li>
                        <li><strong>Outlook limitation:</strong> Many Outlook/Hotmail accounts no longer support SMTP with App Passwords - this is a Microsoft policy, not a bug</li>
                        <li><strong>OAuth 2.0 support:</strong> We're working on adding OAuth 2.0 authentication for Outlook (coming in a future update)</li>
                      </ul>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          placeholder="your.email@outlook.com or your.email@hotmail.com"
                          className={`w-full px-4 py-3 border-2 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${
                            errors.email ? 'border-red-400 bg-red-50' : 'border-gray-300'
                          }`}
                        />
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            className={`w-full px-4 py-3 border-2 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 pr-10 ${
                              errors.password ? 'border-red-400 bg-red-50' : 'border-gray-300'
                            }`}
                          />
                          <button
                        ...
                        <p className="mt-1 text-xs text-red-600 font-semibold">
                          IMPORTANT: You MUST use an App Password (not your regular password). App Passwords are only available if 2FA is enabled. If you don't see "App passwords" option, enable 2FA first.
                        </p>
                        <p className="mt-1 text-xs text-orange-600">
                          If App Passwords are not available for your account, consider using Gmail or a custom SMTP server instead.
                        </p>
                      </div>
                      ...
                      <div className="flex gap-3 pt-2">
                        ...
                        >
                          {saving ? 'Saving & Verifying...' : 'Save & Verify Outlook'}
                        </button>
                        <button
                          onClick={() => {
                            setShowForm(false)
