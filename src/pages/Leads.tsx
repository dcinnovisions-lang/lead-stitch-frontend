                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 relative">
                        <select
                            ...
                            className="w-full px-4 py-2.5 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none"
                        >
                        ...
                        <div className="absolute right-0 top-0 bottom-0 flex items-center pointer-events-none pr-2">
                            {selectedRequirementId !== 'all' && (
                                <button
                                    ...
                                    className="pointer-events-auto mr-1 p-1 hover:bg-red-50 rounded transition-colors"
